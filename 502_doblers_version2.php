...
<p>
  ...
  if(isset($_GET['dinero'])) { // Comprobamos que el formulario realmente recoja un valor
    ...
    echo "$c1 billetes de 500€"; /* Mostramos por pantall el recuento del contador de la cantidad de billetes de 500 una 
    vez salido del bucle */
    echo "<br>";

    // Y así sucesivamente con cada tipo de billete y moneda con su respectivo bucle While y contador
